...
- **Google Translate** api - The API method allows detection of the user's input and translates them to English by default before it is being passed in the backend. Then, all server replies are translated to the supported languages before it is being appended to the html chatbox.
